...
public class Planning implements Psp {
	...
	//Planning class constructor with empty values and no parameters
	public Planning() {
	...
	//Planning class constructor initialized to variables specified in the method parameter header  
