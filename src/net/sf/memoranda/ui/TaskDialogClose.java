...
public class TaskDialogClose extends JDialog {
...
//    JPanel jPanelNotes = new JPanel(new FlowLayout(FlowLayout.LEFT));
    ...
    public TaskDialogClose(Frame frame, String title) {
	...
	this.setSize(new Dimension(430,300));
        ...
        Local.getString("Description"), TitledBorder.LEFT, TitledBorder.BELOW_TOP);
...
//        border7 = BorderFactory.createLineBorder(Color.white, 2);
        ...
        header.setText(Local.getString("CLOSE TASK"));
        header.setIcon(new ImageIcon(net.sf.memoranda.ui.TaskDialogClose.class.getResource(
